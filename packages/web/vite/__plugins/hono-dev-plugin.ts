...
function toWebRequest(req: import("http").IncomingMessage): Request {
  ...
  // url.toString(): Buns Request-Typen akzeptieren nur string oder Request,
  // kein URL-Objekt. duplex gehört inzwischen zum Typ — die frühere
  // Fehlerunterdrückung darüber war selbst zum Fehler geworden.
