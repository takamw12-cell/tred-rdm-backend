...
export default function ChatPage() {
  // ── LOCALISATION SÉCURISÉE (Remplacement du useT() externe) ──────────────
  ...
  const t = (key: string) => {
    const translationDict: Record<string, Record<string, string>> = {
      de: {
        ...
        "chat.you": "Du",
        "chat.ai": "KI-Tutor",
        "calc.explainPrompt": "Erkläre diesen Code Schritt für Schritt:",
        "chat.whyPrompt": "Warum hast du das so berechnet?",
        "chat.engineerPrompt": "Erkläre mir das wie ein Ingenieur.",
        "chat.explainPrompt": "Erkläre es mir anders (Versuch {n}).",
        "chat.selectDoc": "Dokument wählen",
        "chat.hideCourses": "Kursliste verstecken",
        "chat.showCourses": "Kursliste anzeigen",
        "chat.scope": "Umfang",
        "chat.wholeScope": "gesamten Kurs",
        "chat.closeScratchpad": "Notizblock schließen",
        "chat.openScratchpad": "Notizblock öffnen",
        "chat.newChat": "Neuer Chat",
        "chat.history": "Verlauf",
        "chat.trash": "Papierkorb",
        "chat.backToHistory": "Zurück zum Verlauf",
        "chat.select": "Auswählen",
        "chat.emptyTrash": "Papierkorb leeren",
        "chat.deselectAll": "Alle abwählen",
        "chat.selectAll": "Alle auswählen",
        "chat.selectedCount": "{n} ausgewählt",
        "chat.restoreSelected": "Ausgewählte wiederherstellen",
        "chat.deleteSelected": "Ausgewählte löschen",
        "chat.cancel": "Abbrechen",
        "chat.restoreConv": "Wiederherstellen",
        "chat.deletePermanent": "Endgültig löschen",
        "chat.deleteConv": "Löschen",
        "chat.noHistory": "Noch keine Chats",
        "chat.trashEmpty": "Papierkorb ist leer",
        "chat.translating": "Übersetze...",
        "chat.thinking": "Denkt nach",
        "chat.error": "Fehler",
        "chat.retryNow": "Erneut versuchen",
        "chat.attach": "Anhängen",
        "chat.attachHint": "Datei anhängen",
        "chat.attachFiles": "Dateien auswählen",
        "chat.attachFilesHint": "PDFs, Bilder, Textdateien",
        "chat.attachGallery": "Galerie",
        "chat.attachGalleryHint": "Fotos aus der Galerie",
        "chat.attachCamera": "Kamera",
        "chat.attachCameraHint": "Foto aufnehmen",
        "chat.removeImage": "Bild entfernen",
        "chat.removeFile": "Datei entfernen",
        "chat.calcMode": "Rechnermodus",
        "chat.calcModeHint": "Berechnungsmodus",
        "chat.calcModeOnMatlab": "Im MATLAB-Modus",
        "chat.calcModeOnPython": "Im Python-Modus",
        "chat.fileType": "Dateityp nicht unterstützt ({name})",
        "chat.fileTooLarge": "Datei zu groß ({name})",
        "chat.imageFailed": "Bild fehlgeschlagen ({name})",
        "scratchpad.title": "Notizblock",
        "scratchpad.sendToAiPrompt": "Überprüfe meine Rechnung:",
        "chat.q1": "Was ist der Unterschied zwischen Querkraft und Normalkraft?",
        "chat.q2": "Wie berechne ich das Flächenträgheitsmoment?",
        "chat.q3": "Kannst du mir die Biegeformel erklären?",
        "video.chip": "Video erklären",
        "videoSearch.chip": "YouTube suchen",
      ...
      en: {
        ...
        "chat.you": "You",
        "chat.ai": "AI Tutor",
        "calc.explainPrompt": "Explain this code step by step:",
        "chat.whyPrompt": "Why did you calculate it that way?",
        "chat.engineerPrompt": "Explain this like an engineer.",
        "chat.explainPrompt": "Explain it differently (Attempt {n}).",
        "chat.selectDoc": "Select document",
        "chat.hideCourses": "Hide courses",
        "chat.showCourses": "Show courses",
        "chat.scope": "Scope",
        "chat.wholeScope": "whole course",
        "chat.closeScratchpad": "Close scratchpad",
        "chat.openScratchpad": "Open scratchpad",
        "chat.newChat": "New Chat",
        "chat.history": "History",
        "chat.trash": "Trash",
        "chat.backToHistory": "Back to history",
        "chat.select": "Select",
        "chat.emptyTrash": "Empty trash",
        "chat.deselectAll": "Deselect all",
        "chat.selectAll": "Select all",
        "chat.selectedCount": "{n} selected",
        "chat.restoreSelected": "Restore selected",
        "chat.deleteSelected": "Delete selected",
        "chat.cancel": "Cancel",
        "chat.restoreConv": "Restore",
        "chat.deletePermanent": "Delete permanently",
        "chat.deleteConv": "Delete",
        ...
        "chat.attach": "Attach",
        "chat.attachHint": "Attach file",
        "chat.attachFiles": "Choose files",
        "chat.attachFilesHint": "PDFs, images, text files",
        "chat.attachGallery": "Gallery",
        "chat.attachGalleryHint": "Photos from gallery",
        "chat.attachCamera": "Camera",
        "chat.attachCameraHint": "Take a photo",
        "chat.removeImage": "Remove image",
        "chat.removeFile": "Remove file",
        "chat.calcMode": "Calculator mode",
        "chat.calcModeHint": "Calculator mode",
        "chat.calcModeOnMatlab": "In MATLAB mode",
        "chat.calcModeOnPython": "In Python mode",
        "chat.fileType": "File type unsupported ({name})",
        "chat.fileTooLarge": "File too large ({name})",
        "chat.imageFailed": "Image failed ({name})",
        "scratchpad.title": "Scratchpad",
        "scratchpad.sendToAiPrompt": "Check my calculation:",
        "chat.q1": "What is the difference between shear force and normal force?",
        "chat.q2": "How do I calculate the area moment of inertia?",
        "chat.q3": "Can you explain the bending formula to me?",
        "video.chip": "Explain video",
        "videoSearch.chip": "Search YouTube",
    ...
    // Fallback : si la langue choisie n'a pas la clé, on prend l'anglais. Si l'anglais n'a pas la clé, on renvoie le texte brut de la clé.
    return translationDict[locale]?.[key] || translationDict["en"]?.[key] || key;
  };
