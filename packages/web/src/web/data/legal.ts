...
Railway (Hosting, [Region]), Turso (Datenbank, EU), [Objektspeicher]
(Originaldateien, [Region]), Anthropic (Sprachmodell, USA), Resend
...
Hereby I/we (*) rescind the contract concluded by me/us (*) with [Name] („TRED") for the provision of the following service:
...
Diese AGB gelten für alle Verträge zwischen [Name] („TRED") und Verbrauchern
